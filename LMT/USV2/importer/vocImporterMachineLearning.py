...
if __name__ == '__main__':
    ...
    print("Your data should be in yourdatabase.sqlite/usv/ folder, with corresponding .txt containing detection informations generated by the standalone software")    
